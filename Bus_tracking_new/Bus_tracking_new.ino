...
void dataread()
{
  if(data=="14004B21F886"||"14004B21F88614004B21F886")
  {
    ...
    else
    {
      if(s1==true)
      {
        Serial.println("Sebin has Exited");
  ...
  if(data=="14004BE1B709"||"14004BE1B70914004BE1B709")
  {
    digitalWrite(D2,HIGH);
    delay(200);
    digitalWrite(D2,LOW);
    ...
    if(h1==false)
    {
      Serial.println("Hari has Entered");
    ...
    else
    {
      if(h1==true)
      {
        Serial.println("Hari has Exited");
